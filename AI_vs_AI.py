...
def play_AI_vs_AI(depth):
    ...
    def minimax(board, depth, alpha, beta, cur_AI):
        ...
        if cur_AI == AI_Max:
            ...
            for col in valid_locations:
                ...
                new_score = minimax(b_copy, int(depth - 1), alpha, beta, AI_Min)[1]
                if new_score > value:
                    value = new_score
                    column = col
            ...
            for col in valid_locations:
                ...
                new_score = minimax(b_copy, int(depth - 1), alpha, beta, AI_Max)[1]
                if new_score < value:
                    value = new_score
                    column = col
                    beta = min(beta, value)
    ...
    pygame.display.set_caption('Connect 4 : AI Agent Aganist AI Agent')
